...
### 3.43 GET `/discovery/list`

- Same request/response/errors as `GET /discovery/devices`

### 3.44 GET `/discovery/inventory/list`

- Same request/response/errors as `GET /discovery/devices`

### 3.45 GET `/discovery/devices/unauthorized`
...
### 3.48 POST `/discovery/scan/stealth`
...
### 3.49 POST `/discovery/scan/standard`
...
### 3.50 POST `/discovery/scan/aggressive`
