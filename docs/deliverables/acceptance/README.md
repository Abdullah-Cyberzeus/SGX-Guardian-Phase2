...
1. The SOW defines the contractual capability.
2. The use-case document defines the observable pass condition across supported
   network profiles.
...
service, participating clients or peers, and relevant audit records.
