...
export interface FileRecord { id: string; conversationId?: string; name: string; mime: string; size: number; updatedAt: number; encryptedBlob?: EncryptedRecord; revoked?: boolean; expiresAt?: string; }
