...
export interface ContactRecord { did: string; displayName: string; fullName?: string; deviceName?: string; ip?: string; physicalIp?: string; overlayIp?: string; role?: string; memberType?: string; joinDate?: string; online: boolean; presenceStatus?: string; presenceStale?: boolean; lastSeen?: string; updatedAt: number; }
export interface FileRecord { id: string; scopeId: string; vaultId?: string; conversationId?: string; name: string; mime: string; size: number; updatedAt: number; encryptedBlob?: EncryptedRecord; revoked?: boolean; expiresAt?: string; }
