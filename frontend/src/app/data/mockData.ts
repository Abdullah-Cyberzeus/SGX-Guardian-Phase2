...
export const mockAlerts = [
  {
    ...
    description: "Service account svc_monitor used for unauthorized SSH login from an external IP",
    ...
    aiSummary: "A privileged service account attempted lateral movement via SSH. Immediate isolation is recommended.",
    rawTimestamp: "2026-08-31T09:14:00-04:00",
    srcIp: "203.0.113.47",
    srcPort: 51244,
    dstIp: "10.0.2.47",
    dstPort: 22,
    protocol: "TCP",
    signatureId: 1002001,
    signature: "Unauthorized SSH Login by Service Account",
    category: "Authentication",
    blocked: false,
    originalEvidence: "Event type: Authentication Failure · Signature: Unauthorized SSH Login by Service Account · Signature ID: 1002001 · Flow: 203.0.113.47:51244 → 10.0.2.47:22 TCP",
    aiDetail: {
  ...
  },
  {
    ...
    rawTimestamp: "2026-08-31T08:52:00-04:00",
    srcIp: "10.0.1.12",
    srcPort: 51432,
    dstIp: "198.51.100.24",
    dstPort: 443,
    protocol: "TCP",
    signatureId: 1002002,
    signature: "Outbound HTTPS Burst to Unknown Host",
    category: "Network Anomaly",
    blocked: false,
    originalEvidence: "Event type: Network Anomaly · Signature: Outbound HTTPS Burst to Unknown Host · Signature ID: 1002002 · Flow: 10.0.1.12:51432 → 198.51.100.24:443 TCP",
    aiDetail: {
  ...
  },
  {
    ...
    title: "Modbus Register Write Outside Maintenance Window",
    description: "A protected PLC register was written after-hours from an engineering workstation",
    eventType: "Policy Violation",
    status: "Acknowledged",
    timestamp: "7:30 AM",
    date: "Today",
    deviceId: "dev_005",
    device: "Unknown-B24FC9",
    deviceIp: "10.0.4.203",
    os: "Windows 11 Pro",
    aiSummary: "The write occurred outside the approved maintenance window. Review the source workstation and change ticket before the next shift.",
    rawTimestamp: "2026-08-31T07:30:00-04:00",
    srcIp: "10.0.4.203",
    srcPort: 49160,
    dstIp: "10.0.5.18",
    dstPort: 502,
    protocol: "Modbus/TCP",
    signatureId: 1002003,
    signature: "Modbus Write Command on Protected PLC",
    category: "Policy Violation",
    blocked: false,
    originalEvidence: "Event type: Policy Violation · Signature: Modbus Write Command on Protected PLC · Signature ID: 1002003 · Flow: 10.0.4.203:49160 → 10.0.5.18:502 Modbus/TCP",
    aiDetail: {
      whatHappened: "An engineering workstation issued a Modbus write command to a protected PLC register after the approved maintenance window closed. The command targeted a process value normally changed only during supervised changes.",
      whyItMatters: "Unexpected writes to PLC registers outside change windows are a classic indicator of unauthorized tuning or sabotage. The source host should be correlated with the current work order before the next shift begins.",
      actions: [
        "Confirm whether the write is tied to an approved change ticket.",
        "Review the source workstation's session history and operator account.",
        "Temporarily restrict further write access to the target PLC until validated.",
        "Document the event in the shift log before handing off.",
      ],
    },
    archived: false,
  },
