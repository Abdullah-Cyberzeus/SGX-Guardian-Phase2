    ...
    <main className="flex-1 overflow-y-auto p-4 md:p-6">
      <div className="mx-auto max-w-2xl space-y-4">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <button onClick={() => void refresh()} className="flex w-full items-center justify-center gap-2 rounded-md border border-border px-4 py-3 text-sm font-semibold hover:bg-muted"><RefreshCw size={17} />Refresh session</button>
          ...
          <button onClick={() => void logoutEverywhere()} className="flex w-full items-center justify-center gap-2 rounded-md border border-destructive/40 px-4 py-3 text-sm font-semibold text-destructive hover:bg-destructive/10"><UsersRound size={17} />Sign out everywhere</button>
          <button onClick={() => void removeBrowser()} className="flex w-full items-center justify-center gap-2 rounded-md border border-destructive/40 px-4 py-3 text-sm font-semibold text-destructive hover:bg-destructive/10"><Trash2 size={17} />Remove this browser</button>
        </div>
      </div>
    </main>
  </div>;
