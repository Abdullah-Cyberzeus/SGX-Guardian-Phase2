...
import {
  ...
  Link, QrCode, Search, MessageSquare, Users, Network as NetworkIcon, PhoneCall,
  Trash2, AlertTriangle, FolderOpen
} from "lucide-react";
...
type Tab = "chat" | "calls" | "files" | "members" | "topology";
...
export function NW04CircleDetail() {
  ...
  const tabs = [
    ...
    { id: "topology", label: "Network", icon: NetworkIcon },
  ];
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {member.role === "Owner" && <StatusBadge status="Owner" variant="info" />}
                      </div>
