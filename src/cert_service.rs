...
//! All paths under /var/lib/sgx-guardian/nebula/
//!
//! Flow:
//!   1. Request arrives → check if YAML already exists
//!   2. If no YAML → create YAML at nebula/requests/<node>.yaml
//!   3. If YAML exists → skip creation, continue polling
//!   4. Admin edits YAML: approve: true
//!   5. Service detects → calls NebulaCA::issue_node_cert
//!   6. Reads generated cert/key → returns via gRPC
//!
//! IMPROVEMENT #1: YAML is NEVER overwritten on repeated requests.
