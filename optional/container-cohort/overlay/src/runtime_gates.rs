...
pub struct RuntimeGates {
    ...
    /// Secondary gate required before a real board may use software keys.
    pub allow_debug_soft_keys: bool,
...
impl RuntimeGates {
    fn load() -> Self {
        Self {
            ...
            allow_debug_soft_keys: env_true("SGX_ALLOW_DEBUG_SOFT_KEYS"),
    ...
    pub fn log_summary(&self) {
        tracing::info!(
            "Runtime gates: nebula={} relay_tc={} relay_stats={} tunnel={} cot={} bt={} cell={} sat={} refresh={} p2p={} att={} bcast={} cloud={} expiry={} lhhealth={} swkeys={} allow_debug_soft_keys={} dkp_rot={} startup_attest={} sbcheck={} pcr={} audit={} grpc={} cert_bootstrap={} policy={} node_listener={} ssscli_timeout_secs={} cooldown_ms={}",
            self.disable_nebula,
